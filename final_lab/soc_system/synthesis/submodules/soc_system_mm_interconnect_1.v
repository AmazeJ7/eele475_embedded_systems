...
module soc_system_mm_interconnect_1 (
		...
		output wire [2:0]  Qsys_LED_control_0_s1_address,                          //                            Qsys_LED_control_0_s1.address
	...
	wire    [3:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> sysid_qsys_control_slave_agent:cp_channel
	...
	wire  [104:0] qsys_led_control_0_s1_agent_rf_source_data;                                 // Qsys_LED_control_0_s1_agent:rf_source_data -> Qsys_LED_control_0_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] qsys_led_control_0_s1_agent_rsp_fifo_out_data;                              // Qsys_LED_control_0_s1_agent_rsp_fifo:out_data -> Qsys_LED_control_0_s1_agent:rf_sink_data
	...
	wire          cmd_mux_003_src_valid;                                                      // cmd_mux_003:src_valid -> Qsys_LED_control_0_s1_agent:cp_valid
	wire  [103:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> Qsys_LED_control_0_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                      // Qsys_LED_control_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> Qsys_LED_control_0_s1_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                              // cmd_mux_003:src_startofpacket -> Qsys_LED_control_0_s1_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                // cmd_mux_003:src_endofpacket -> Qsys_LED_control_0_s1_agent:cp_endofpacket
	...
	wire  [103:0] qsys_led_control_0_s1_agent_rp_data;                                        // Qsys_LED_control_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire          qsys_led_control_0_s1_agent_rdata_fifo_src_valid;                           // Qsys_LED_control_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] qsys_led_control_0_s1_agent_rdata_fifo_src_data;                            // Qsys_LED_control_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          qsys_led_control_0_s1_agent_rdata_fifo_src_ready;                           // avalon_st_adapter_003:in_0_ready -> Qsys_LED_control_0_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                          // avalon_st_adapter_003:out_0_valid -> Qsys_LED_control_0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                           // avalon_st_adapter_003:out_0_data -> Qsys_LED_control_0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                          // Qsys_LED_control_0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                          // avalon_st_adapter_003:out_0_error -> Qsys_LED_control_0_s1_agent:rdata_fifo_sink_error
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (mm_bridge_0_reset_reset_bridge_in_reset_reset),    // in_rst_0.reset
		.in_0_data      (qsys_led_control_0_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (qsys_led_control_0_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (qsys_led_control_0_s1_agent_rdata_fifo_src_ready), //         .ready
